defmodule AjisaiWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      AjisaiWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule AjisaiWeb.PageLive do
        use AjisaiWeb, :live_view

        on_mount {AjisaiWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{AjisaiWeb.UserAuth, :ensure_authenticated}] do
  ...
  defp signed_in_path(_conn), do: ~p"/issues"
end
