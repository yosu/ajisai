defmodule AjisaiWeb do
  ...
  def static_paths, do: ~w(assets fonts images icon.svg favicon.ico robots.txt)
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: AjisaiWeb.Layouts]
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: AjisaiWeb.Router,
        statics: AjisaiWeb.static_paths()
    end
  end
